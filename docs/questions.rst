...
* If pyarmor works before, but suddenly it doesn't work. Please make a clean
  uninstallation, remove all the files generated by pyarmor, re-install pyarmor,
  and start everything from refresh state.
