...
About third-party interperter, for example Jython, and any embeded Python C/C++ code, only they could work with CPython :term:`extension module`, they could work with Pyarmor. Check third-party interperter documentation to make sure this.
