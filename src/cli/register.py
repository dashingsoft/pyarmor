...
class Register(object):
    ...
    def generate_group_device(self, devid):
        ...
        uinfo = uname()
        verflag = self.ctx.cfg['builder'].getint('group_license_flag', 16)
        tpl = Template('\n'.join([
            ...
            machine=self._get_machine_id(verflag).decode('utf-8')
        )
