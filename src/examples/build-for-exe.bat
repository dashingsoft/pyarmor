...
CALL pyarmor.bat config --runtime-path="" --disable-restrict-mode=1 --manifest "include global-include *.py, exclude setup.py pytransform.py, prune build, prune dist"
